...
<body class="text-gray-900 font-sans antialiased md:p-0 p-4">
  ...
  <div class="container mx-auto w-full max-w-9xl md:flex justify-between mb-20 mt-8 items-center">
    ...
    <ul class="mb-4 block sm:inline sm:mb-0 text-center sm:text-left">
      <li class="inline mr-5">
        <a href="{{ $page->baseUrl }}/features" class="relative transition-colors hover:bg-yellow-100 px-2 py-1 rounded">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline icon-header relative" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <li class="inline mr-5">
        <a href="https://docs.officelife.io/documentation/introduction.html" class="relative transition-colors hover:bg-yellow-100 px-2 py-1 rounded">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline icon-header relative" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <li class="inline mr-8">
        <a href="https://github.com/officelifehq/officelife" class="relative transition-colors hover:bg-yellow-100 px-2 py-1 rounded">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline icon-header relative" viewBox="0 0 24 24">
  ...
  <div class="bg-gray-900 text-white pb-20 mt-20">
    <div class="container mx-auto w-full max-w-4xl text-center pt-10">
      <ul class="">
        <li class="inline mr-5">Made with <span style="color: transparent; text-shadow: 0 0 #fff;">♥︎</span> in Montreal and Paris.</li>
        <li class="inline mr-5">Privacy policy</li>
        <li class="inline mr-5">Terms of use</li>
        <li class="inline">Copyright ©2021 OfficeLife.</li>
      </ul>
    </div>
  </div>
